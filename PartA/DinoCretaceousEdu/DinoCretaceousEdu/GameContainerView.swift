...
struct GameContainerView: View {
    ...
    @State private var showFactsAtGameOver = false
        ...
        ZStack {
            ...
            if showGameOver {
                ...
                VStack(spacing: 16) {
                    ...
                    Button {
                        showFactsAtGameOver.toggle()
                    } label: {
                        Text(showFactsAtGameOver ? "Hide Facts" : "View Cretaceous Facts")
                            .font(.subheadline)
                            .padding(8)
